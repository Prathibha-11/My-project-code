...
Original file is located at
    https://colab.research.google.com/drive/1fBy0L8Ij3A8k09o65MBeuM3uSYmk1NL-
"""
...
image = cv2.imread("/content/Road_image.jpg")
# Object Detection
results = model(image)
# Display Results
...
frame1 = cv2.imread("/content/Frame_1.jpg", 0)
frame2 = cv2.imread("/content/Frame_2.jpg", 0)
...
!pip install gymnasium[box2d] pygameimageio
